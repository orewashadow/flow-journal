...
export default function App() {
  ...
  if (loading) return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', background:'#0F1F4A' }}>
      <FlowLogo />
    </div>
  )
...
function FlowLogo() {
  return (
    <div style={{ display:'flex', alignItems:'center', gap:10 }}>
      <div style={{ width:36, height:36, background:'#3B82F6', borderRadius:10, display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
      ...
      <span style={{ fontFamily:"'Syne',sans-serif", fontSize:22, fontWeight:500, color:'#fff', letterSpacing:1 }}>FLOW</span>
    </div>
  )
}
